...
@Configuration
@EnableSwagger2
/* Swagger UI Implementation for Audit Service */
public class SwaggerConfigAuditService {

    @Bean
    public Docket app(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.audit_service"))
                .paths(regex("/audit.*")).build().apiInfo(metaData());
    }
